...
This module consumes the split AI `02_ai/evidence_ontology` outputs and designs project-level Control, Test, and Policy Candidate artifacts.

## Responsibility Boundary

- `02_ai/evidence_ontology` owns AI Official Source, Evidence, and Requirement Candidate records.
- `02_ai/gateway_rules` owns AI Control, Test, and Policy Candidate records.
...
```bash
python 02_ai/gateway_rules/scripts/validate_gateway_rules.py
```
