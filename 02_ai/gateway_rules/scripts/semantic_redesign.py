...
requirements = load(
    PROJECT_ROOT / "02_ai" / "evidence_ontology" / "processed" / "requirement_candidates.json"
)
evidence = load(PROJECT_ROOT / "02_ai" / "evidence_ontology" / "processed" / "evidence_master.json")
    ...
    controls.append(
        {
            ...
            "provenance": {
                "source": "02_ai/evidence_ontology/processed/requirement_candidates.json",
