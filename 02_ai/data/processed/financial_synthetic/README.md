...
Source Dataset -> Jupyter Cleaning -> `02_ai/data/processed/financial_synthetic` Dataset Snapshot -> 04 Experiment -> Validation Artifact -> Gateway Policy Candidate validation
