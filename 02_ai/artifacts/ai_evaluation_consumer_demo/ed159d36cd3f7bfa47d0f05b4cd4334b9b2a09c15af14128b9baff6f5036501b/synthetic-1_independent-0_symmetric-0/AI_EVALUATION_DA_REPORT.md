...
- Test: None
- p-value: None
- Holm-adjusted p-value: None
- Effect size: {"name": "paired_rate_difference", "value": -0.2857142857142857, "direction": "first model minus second model"}
- Interpretation: No inferential conclusion: Case independence is not in the bundle; analyst confirmation is required.
...
- p-value: None
- Holm-adjusted p-value: None
- Effect size: {"name": "median_paired_difference_millis", "value": -20.0, "direction": "first model minus second model"}
- Interpretation: No inferential conclusion: Case independence is not in the bundle; analyst confirmation is required.
