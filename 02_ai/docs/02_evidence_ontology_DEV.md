...
| Control / Test / Policy Candidate | DOWNSTREAM | `02_ai/gateway_rules` ownership |
...
- [ ] `02_ai/gateway_rules`의 downstream todo인 `GR-0008`과 AI Evidence `EV-00038`, `EV-00039`의 cross-domain reference를 검토한다.
